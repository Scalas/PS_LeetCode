...
cases = [
    {
        'input': {
            'commands': ["UndergroundSystem", "checkIn", "checkIn", "checkIn", "checkOut", "checkOut", "checkOut",
                         "getAverageTime", "getAverageTime", "checkIn", "getAverageTime", "checkOut", "getAverageTime"],
            'args': [[], [45, "Leyton", 3], [32, "Paradise", 8], [27, "Leyton", 10], [45, "Waterloo", 15],
        ...
        'output': [None, None, None, None, None, None, None, 14.00000, 11.00000, None, 11.00000, None, 12.00000],
    },
    {
        'input': {
            'commands': ["UndergroundSystem", "checkIn", "checkOut", "getAverageTime", "checkIn", "checkOut",
                         "getAverageTime", "checkIn", "checkOut", "getAverageTime"],
            'args': [[], [10, "Leyton", 3], [10, "Paradise", 8], ["Leyton", "Paradise"], [5, "Leyton", 10],
